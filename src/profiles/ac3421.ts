...
/**
 * Philips AC3421 — reference profile ported from kongo09's PhilipsAirPurifierCoap
 ...
 */
export const AC3421Profile: DeviceProfile = {
  id: 'AC3421',
  displayName: 'Philips AC3421',
  verification: 'reference',
  matchModelPrefixes: ['AC3421'],
  family: 'NEW2',
