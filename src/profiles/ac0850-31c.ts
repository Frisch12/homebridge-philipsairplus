...
/**
 * Philips AC0850/31 (Combo) — reference profile ported from kongo09's PhilipsAirPurifierCoap
 ...
 */
export const AC0850_31CProfile: DeviceProfile = {
  id: 'AC0850-31C',
  displayName: 'Philips AC0850/31 (Combo)',
  verification: 'reference',
  matchModelPrefixes: ['AC0850/31', 'AC0850-31'],
