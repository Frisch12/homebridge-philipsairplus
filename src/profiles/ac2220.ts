...
/**
 * Philips AC2220 — reference profile ported from kongo09's PhilipsAirPurifierCoap
 ...
 */
export const AC2220Profile: DeviceProfile = {
  id: 'AC2220',
  displayName: 'Philips AC2220',
  verification: 'reference',
  matchModelPrefixes: ['AC2220'],
  family: 'NEW2',
