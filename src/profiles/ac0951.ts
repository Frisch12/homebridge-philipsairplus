...
/**
 * Philips AC0951 — reference profile ported from kongo09's PhilipsAirPurifierCoap
 ...
 */
export const AC0951Profile: DeviceProfile = {
  id: 'AC0951',
  displayName: 'Philips AC0951',
  verification: 'reference',
  matchModelPrefixes: ['AC0951'],
  family: 'NEW2',
