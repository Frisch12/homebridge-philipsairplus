...
/**
 * Philips AC0850/20 (Combo) — reference profile ported from kongo09's PhilipsAirPurifierCoap
 ...
 */
export const AC0850_20CProfile: DeviceProfile = {
  id: 'AC0850-20C',
  displayName: 'Philips AC0850/20 (Combo)',
  verification: 'reference',
  matchModelPrefixes: ['AC0850/20', 'AC0850-20'],
