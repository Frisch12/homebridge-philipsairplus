...
/**
 * Philips AC4220 — reference profile ported from kongo09's PhilipsAirPurifierCoap
 ...
 */
export const AC4220Profile: DeviceProfile = {
  id: 'AC4220',
  displayName: 'Philips AC4220',
  verification: 'reference',
  matchModelPrefixes: ['AC4220'],
  family: 'NEW2',
