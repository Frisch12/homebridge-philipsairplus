...
/**
 * Philips AC2210 — reference profile ported from kongo09's PhilipsAirPurifierCoap
 ...
 */
export const AC2210Profile: DeviceProfile = {
  id: 'AC2210',
  displayName: 'Philips AC2210',
  verification: 'reference',
  matchModelPrefixes: ['AC2210'],
  family: 'NEW2',
