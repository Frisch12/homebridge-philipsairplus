...
/**
 * Philips AC3221 — reference profile ported from kongo09's PhilipsAirPurifierCoap
 ...
 */
export const AC3221Profile: DeviceProfile = {
  id: 'AC3221',
  displayName: 'Philips AC3221',
  verification: 'reference',
  matchModelPrefixes: ['AC3221'],
  family: 'NEW2',
