...
/**
 * Philips AC0850/81 — reference profile ported from kongo09's PhilipsAirPurifierCoap
 ...
 */
export const AC0850_81Profile: DeviceProfile = {
  id: 'AC0850-81',
  displayName: 'Philips AC0850/81',
  verification: 'reference',
  matchModelPrefixes: ['AC0850/81', 'AC0850-81'],
