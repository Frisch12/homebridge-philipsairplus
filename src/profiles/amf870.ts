...
/**
 * Philips AMF870 — reference profile ported from kongo09's PhilipsAirPurifierCoap
 ...
 */
export const AMF870Profile: DeviceProfile = {
  id: 'AMF870',
  displayName: 'Philips AMF870',
  verification: 'reference',
  matchModelPrefixes: ['AMF870'],
  family: 'NEW2',
