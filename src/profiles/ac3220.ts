...
/**
 * Philips AC3220 — reference profile ported from kongo09's PhilipsAirPurifierCoap
 ...
 */
export const AC3220Profile: DeviceProfile = {
  id: 'AC3220',
  displayName: 'Philips AC3220',
  verification: 'reference',
  matchModelPrefixes: ['AC3220'],
  family: 'NEW2',
