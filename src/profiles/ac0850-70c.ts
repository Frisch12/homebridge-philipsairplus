...
/**
 * Philips AC0850/70 (Combo) — reference profile ported from kongo09's PhilipsAirPurifierCoap
 ...
 */
export const AC0850_70CProfile: DeviceProfile = {
  id: 'AC0850-70C',
  displayName: 'Philips AC0850/70 (Combo)',
  verification: 'reference',
  matchModelPrefixes: ['AC0850/70', 'AC0850-70'],
