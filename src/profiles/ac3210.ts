...
/**
 * Philips AC3210 — reference profile ported from kongo09's PhilipsAirPurifierCoap
 ...
 */
export const AC3210Profile: DeviceProfile = {
  id: 'AC3210',
  displayName: 'Philips AC3210',
  verification: 'reference',
  matchModelPrefixes: ['AC3210'],
  family: 'NEW2',
