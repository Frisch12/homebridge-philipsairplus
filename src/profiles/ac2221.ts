...
/**
 * Philips AC2221 — reference profile ported from kongo09's PhilipsAirPurifierCoap
 ...
 */
export const AC2221Profile: DeviceProfile = {
  id: 'AC2221',
  displayName: 'Philips AC2221',
  verification: 'reference',
  matchModelPrefixes: ['AC2221'],
  family: 'NEW2',
